...
urlpatterns = [
    ...
    url(r'^main_no_sign', views.main_no_sign, name='main_no_sign'),
    url(r'^recognition/$', views.recognition_post, name='recognition'),
    url(r'^recognition_no_sign', views.recognition_no_sign, name='recognition_no_sign'),
    url(r'^change_passwd', views.change_passwd, name='change_passwd'),
    url(r'^result$', views.result, name='result'),
    url(r'^result_no_sign$', views.result_no_sign, name='result_no_sign'),
    url(r'^history', views.historical_actions, name='history'),
    url(r'^find/$', views.find, name='find'),
    url(r'^find_no_sign', views.find_no_sign, name='find_no_sign'),
